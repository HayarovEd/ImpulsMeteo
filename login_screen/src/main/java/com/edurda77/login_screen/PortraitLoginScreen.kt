...
fun PortraitLoginScreen (
    ...
    Log.d("TEST ERROR LOGIN", "snakeBarHostState $snakeBarHostState")
   //Log.d("TEST ERROR LOGIN", "isLoading $isLoading")
    //Log.d("TEST ERROR LOGIN", "email $email")
    //Log.d("TEST ERROR LOGIN", "password $password")
    Scaffold(
