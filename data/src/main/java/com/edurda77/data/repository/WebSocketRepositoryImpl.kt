                ...
                .collect {
                    ...
                    when {
                        message.contains("DEVICE_CREATED") -> {
                            val result = json.decodeFromString<com.edurda77.data.remote.web_socket.WsContentDto<com.edurda77.data.remote.device.DeviceWsDto>>(message)
                        ...
                        message.contains("DEVICE_DELETED") -> {
                            val result = json.decodeFromString<com.edurda77.data.remote.web_socket.WsContentDto<String>>(message)
                            emit(ResultWork.Success(WebSocketMessage.DeviceDelete(result.content)))
                        }

                        message.contains("USER_CREATED") -> {
                            val result = json.decodeFromString<com.edurda77.data.remote.web_socket.WsContentDto<com.edurda77.data.remote.user.UserDto>>(message)
                        ...
                        message.contains("FAVORITE_UPDATED") -> {
                            val result =
                                json.decodeFromString<com.edurda77.data.remote.web_socket.WsContentDto<List<com.edurda77.data.remote.favorite.FavoriteDto>>>(message)
                        ...
                        message.contains("PARAM_DATA_UPDATE") -> {
                            val result = json.decodeFromString<com.edurda77.data.remote.web_socket.WsContentDto<com.edurda77.data.remote.param.ParamDto>>(message)
